...
function CosineMovementComponent:randomizeParameters()
    ...
    print(
        "  AGGRESSIVE wave: Factor("
            .. string.format("%.1f", self.factor)
            .. ") affects PATH+WAVES Amp("
            .. math.floor(self.amplitudeX)
            .. ","
            .. math.floor(self.amplitudeY)
            .. ") Freq("
            .. string.format("%.1f", self.frequencyX)
            .. ","
            .. string.format("%.1f", self.frequencyY)
            .. ") - EXTREME & FAST!"
    )
end
